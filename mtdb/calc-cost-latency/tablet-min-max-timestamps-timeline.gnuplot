...
plot \
FN_IN u 2:5:2 w labels not

# ## x  y  xlow  xhigh  ylow  yhigh
# plot \
# FN_IN u 2:5:2:5:6:7:1 w boxxyerrorbars linecolor variable not, \
# FN_IN u 2:5:2 w labels not

#FN_IN u 2:5:1:1 w labels textcolor variable not

#FN_IN u 2:5:2:5:6:7:1 w boxxyerrorbars palette
...
## x  y  xlow  xhigh  ylow  yhigh
#plot \
#FN_IN u 2:7:2:5:7:($7+$6) w boxxyerrorbars lc rgb "blue" not, \
...
#FN_IN u 2:7:(0):6         w vectors nohead lw 2 lt 1 lc rgb "black" t "Created", \
#FN_IN u 4:7:(0):6         w vectors nohead lw 2 lt 0 lc rgb "black" t "Deleted", \
#FN_IN u 2:($7+$6/2.0):1   w labels right offset -0.5,0 font ",10" not
#
