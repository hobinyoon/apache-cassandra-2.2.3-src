...
def Plot():
	with Cons.MeasureTime("Plotting ..."):
		...
		env["L_EM_LABEL_X"] = str(PlotData.Throughput("L-EM", "lat_w.avg"))
		env["L_EM_LABEL_Y"] = str(PlotData.Latency   ("L-EM", "lat_w.avg"))
		...
		env["L_EM_LABEL_X"] = str(PlotData.Throughput("L-EM", "lat_w._99"))
		env["L_EM_LABEL_Y"] = str(PlotData.Latency   ("L-EM", "lat_w._99"))
		...
		env["L_EM_LABEL_X"] = str(PlotData.Throughput("L-EM", "lat_r.avg"))
		env["L_EM_LABEL_Y"] = str(PlotData.Latency   ("L-EM", "lat_r.avg"))
		env["Y_MAX"] = str(PlotData.MaxLatency("avg"))
		...
		env["L_EM_LABEL_X"] = str(PlotData.Throughput("L-EM", "lat_r._99"))
		env["L_EM_LABEL_Y"] = str(PlotData.Latency   ("L-EM", "lat_r._99"))
		env["Y_MAX"] = str(PlotData.MaxLatency("_99"))
