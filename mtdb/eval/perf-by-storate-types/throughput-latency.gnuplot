...
COL_IDX_LATENCY = system("echo $COL_IDX_LATENCY")
AVG_AVG_LAT_EBS_MAG_X = system("echo $AVG_AVG_LAT_EBS_MAG_X")
AVG_AVG_LAT_EBS_MAG_Y = system("echo $AVG_AVG_LAT_EBS_MAG_Y")
AVG_AVG_LAT_EBS_SSD_X = system("echo $AVG_AVG_LAT_EBS_SSD_X")
AVG_AVG_LAT_EBS_SSD_Y = system("echo $AVG_AVG_LAT_EBS_SSD_Y")
AVG_AVG_LAT_LOCAL_SSD_X = system("echo $AVG_AVG_LAT_LOCAL_SSD_X")
AVG_AVG_LAT_LOCAL_SSD_Y = system("echo $AVG_AVG_LAT_LOCAL_SSD_Y")
