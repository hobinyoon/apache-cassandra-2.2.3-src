...
set ylabel "# of accesses\nby SSTables (normalized)" offset 1.6,0
...
MAX_HEIGHT=1.5*GPVAL_DATA_Y_MAX
...
FN_IN u 2:($1==i ? (($1-1)+($3/MAX_HEIGHT)) : 1/0) w filledcurves y1=(i-1) lc rgb "#FFC0C0" not, \
for [i=1:NUM_SSTABLES] \
FN_IN u 2:($1==i ? (($1-1)+($3/MAX_HEIGHT)) : 1/0) w linespoints pt 7 lc rgb "#FF0000" not
